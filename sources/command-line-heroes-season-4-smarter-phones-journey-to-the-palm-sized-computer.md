...
它们并没有主动连接任何东西，因此如果你在你的 Sion 以及 Casio Wizard 中有一个地址簿，那么在你的电脑上将不能对你的地址簿做任何操作。我们并没有把它定位为独立的标准手持设备，相反的，我们把它定位为电脑的一个附属物。一个你电脑之上的窗口，能够把电脑的一部分随身携带，这样的定位让同步功能成为核心。
