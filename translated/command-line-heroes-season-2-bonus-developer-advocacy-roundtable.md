...
[#]: reviewer: (windgeek, Northurland, wxy)
[#]: publisher: ( )
[#]: url: ( )
...
大家好，我是 Saron Yitbarek，这里是红帽的原创播客节目《<ruby>代码英雄<rt>Command Line Heroes</rt></ruby>》的特别篇。我们的节目在第 2 季去了很多地方。我们探索了[编程语言][10]、[数据大爆炸][14]、[安全危机][13]以及[无服务器][15]时代的到来，我们甚至去了[火星][16]。
...
校对：[windgeek](https://github.com/windgeek),  [Northurland](https://github.com/Northurland), [wxy](https://github.com/wxy)
