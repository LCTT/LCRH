...
> 导语：它们不适合放在你的口袋里。但在当时，<ruby>小型机<rt>minicomputer</rt></ruby>比之前的房间大小的<ruby>大型机<rt>mainframe</rt></ruby>的尺寸小了一个数量级。它们为可以装进包里的<ruby>个人电脑<rt>Personal Computer</rt></ruby>（PC），以及最终你口袋里的手机铺平了道路。
>
