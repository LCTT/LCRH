...
每次周会，他都能想出一个不可思议的借口来解释为什么他没赶上最终期限，或他没能达成自己预定解决 bug 的进度。而且每一次都是因为有人没能完成某些他们自己都不知道要做的事。事实上，公司大部分代码是 Rick 一个人写的，所以根本没有所谓的代码检查过程，只有 Rick 不断地在别人不知道的时候直接更新主代码库。
